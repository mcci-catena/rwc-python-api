##############################################################################
# 
# Module: rwc5020x_test_1_21.py
#
# Description:
#     Unit test cases for sw version 1.210
#
# Copyright notice:
...
class RwcApiTest(unittest.TestCase):
    ...
    def test_com_query_identification(self):
        self.assertEqual(self.rwctest.query_identification(), 'RWC5020A LoRaWAN Tester, Ver=1.210,SN=RWC50201760009 ')
    ...
    def test_protocoldownlinkslot(self):
        ...
        self.assertEqual(self.rwctest.protocol_setdownlinkslot('RX2'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.protocol_getdownlinkslot(), 'RX2', 'Failed to read')
        self.assertEqual(self.rwctest.protocol_setdownlinkslot('RX1&RX2'), 'ACK', 'Set Operation Failed')
    ...
    def test_nstrx_cr(self):
        self.assertEqual(self.rwctest.nst_rx_setcr('4_5'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.nst_rx_getcr(), '4_5', 'Failed to read')
        self.assertEqual(self.rwctest.nst_rx_setcr('4_6'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.nst_rx_getcr(), '4_6', 'Failed to read')
        self.assertEqual(self.rwctest.nst_rx_setcr('4_7'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.nst_rx_getcr(), '4_7', 'Failed to read')
        self.assertEqual(self.rwctest.nst_rx_setcr('4_8'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.nst_rx_getcr(), '4_8', 'Failed to read')
        self.assertEqual(self.rwctest.nst_rx_setcr('NO_CRC'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.nst_rx_getcr(), 'NO_CRC', 'Failed to read')
    ...
    def test_querysysversion(self):
        self.assertEqual(self.rwctest.query_sysversion(), '1.210', 'Reading System Software Version Failed.')
