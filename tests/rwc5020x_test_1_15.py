##############################################################################
# 
# Module: rwc5020x_test_1_15.py
#
# Description:
#     Unit test cases for sw version 1.150
#
# Copyright notice:
...
class RwcApiTest(unittest.TestCase):
    ...
    def test_com_query_identification(self):
        self.assertEqual(self.rwctest.query_identification(), 'RWC5020A LoRa Tester, Ver=1.150,SN=RWC50201760009 ')
    ...
    def test_protocolsetnstfpending(self):
        ...
        self.assertEqual(self.rwctest.protocol_getnstfpending(), 'ON', 'Failed to read')
    ...
    def test_linkbeacondatarate(self):
        ...
        self.assertEqual(self.rwctest.link_setbeacondatarate('DR_2'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.link_getbeacondatarate(), 'DR_2', 'Failed to read')
        self.assertEqual(self.rwctest.link_setbeacondatarate('DR_3'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.link_getbeacondatarate(), 'DR_3', 'Failed to read')
        self.assertEqual(self.rwctest.link_setbeacondatarate('DR_4'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.link_getbeacondatarate(), 'DR_4', 'Failed to read')
        self.assertEqual(self.rwctest.link_setbeacondatarate('DR_5'), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.link_getbeacondatarate(), 'DR_5', 'Failed to read')
    ...
    def test_querysysversion(self):
        self.assertEqual(self.rwctest.query_sysversion(), '1.150', 'Reading System Software Version Failed.')
