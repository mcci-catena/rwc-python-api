##############################################################################
# 
# Module: rwc5020x_test_1_17.py
#
# Description:
#     Unit test cases for sw version 1.170
#
# Copyright notice:
...
class RwcApiTest(unittest.TestCase):
    ...
    def test_com_query_identification(self):
        self.assertEqual(self.rwctest.query_identification(), 'RWC5020A LoRaWAN Tester, Ver=1.170,SN=RWC50201760009 ')
    ...
    def test_linkmacinterval(self):
        self.assertEqual(self.rwctest.link_setmacinterval(5), 'ACK', 'Set Operation Failed')
        self.assertEqual(self.rwctest.link_getmacinterval(), '5', 'Failed to read')
    ...
    def test_querysysversion(self):
        self.assertEqual(self.rwctest.query_sysversion(), '1.170', 'Reading System Software Version Failed.')
