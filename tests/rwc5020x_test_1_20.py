##############################################################################
# 
# Module: rwc5020x_test_1_20.py
#
# Description:
#     Unit test cases for sw version 1.200
#
# Copyright notice:
...
class RwcApiTest(unittest.TestCase):
    ...
    def test_com_query_identification(self):
        self.assertEqual(self.rwctest.query_identification(), 'RWC5020A LoRaWAN Tester, Ver=1.204,SN=RWC50201760009 ')
    ...
    def test_querysysversion(self):
        self.assertEqual(self.rwctest.query_sysversion(), '1.204', 'Reading System Software Version Failed.')
